...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("ѕоиск студентов");
		try {
			...
			System.out.println("ѕо вашему запросу ничего не найдено");
		}
		System.out.println();

		System.out.println("”даление студента");
		group.deleteStudent(studentSeven);
		System.out.println();
		group.getInformation();

		System.out.println();
		System.out.println("»нтерактивное добавление студента");
		group.interactiveAddingStudent();
		System.out.println();
		group.getInformation();

		System.out.println();
		System.out.println("¬оеннооб€занные студенты");
		...
		System.out.println();
		System.out.println("—ортировка по фамилии");
		Student[] sortArray = new Student[] {};
		sortArray = group.getGroup(); // заполн€ем массив всеми студентами
		...
		System.out.println();
		System.out.println("—ортировка по параметру");
		...
		String text = group.reportToCSV();
		File file = new File("report.csv");
		group.saveStringToFile(text, file);
